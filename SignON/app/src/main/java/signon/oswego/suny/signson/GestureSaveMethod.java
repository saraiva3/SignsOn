...
import signon.oswego.suny.signson.EmgCharacteristicData;
import signon.oswego.suny.signson.EmgData;
import signon.oswego.suny.signson.MyoDataFileReader;
...
public class GestureSaveMethod {
    ...
    private ArrayList<EmgCharacteristicData> rawDataList = new ArrayList<EmgCharacteristicData>();
    private ArrayList<EmgData> maxDataList = new ArrayList<EmgData>();
    private ArrayList<EmgData> compareGesture = new ArrayList<EmgData>();
    ...
    public void addData(byte[] data) {
        ...
        if (dataCounter % SAVE_DATA_LENGTH == 0) {
            ...
            rawDataList = new ArrayList<EmgCharacteristicData>();
        }
...
*/
        ...
        maxDataList = new ArrayList<EmgData>();
    }
